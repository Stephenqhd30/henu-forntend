...
export async function getSystemMessagesVoByIdUsingGet(
  ...
  return request<API.BaseResponseSystemMessagesVO_>('/api/systemMessages/get/vo', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listSystemMessagesByPageUsingPost(
  ...
  return request<API.BaseResponsePageSystemMessages_>('/api/systemMessages/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listSystemMessagesVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageSystemMessagesVO_>('/api/systemMessages/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
