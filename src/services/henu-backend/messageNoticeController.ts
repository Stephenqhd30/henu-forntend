...
export async function getMessageNoticeVoByIdUsingGet(
  ...
  return request<API.BaseResponseMessageNoticeVO_>('/api/messageNotice/get/vo', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listMessageNoticeByPageUsingPost(
  ...
  return request<API.BaseResponsePageMessageNotice_>('/api/messageNotice/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMessageNoticeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageMessageNoticeVO_>('/api/messageNotice/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyMessageNoticeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageMessageNoticeVO_>('/api/messageNotice/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
