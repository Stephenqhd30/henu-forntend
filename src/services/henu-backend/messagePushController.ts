...
export async function listMessagePushByPageUsingPost(
  ...
  return request<API.BaseResponsePageMessagePush_>('/api/messagePush/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMessagePushVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageMessagePushVO_>('/api/messagePush/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyMessagePushVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageMessagePushVO_>('/api/messagePush/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
