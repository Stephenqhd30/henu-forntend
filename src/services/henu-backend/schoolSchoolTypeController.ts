...
export async function getSchoolSchoolTypeVoByIdUsingGet(
  ...
  return request<API.BaseResponseSchoolSchoolTypeVO_>('/api/schoolSchoolType/get/vo', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listSchoolSchoolTypeByPageUsingPost(
  ...
  return request<API.BaseResponsePageSchoolSchoolType_>('/api/schoolSchoolType/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listSchoolSchoolTypeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageSchoolSchoolTypeVO_>('/api/schoolSchoolType/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMySchoolSchoolTypeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageSchoolSchoolTypeVO_>('/api/schoolSchoolType/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
