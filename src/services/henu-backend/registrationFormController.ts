...
export async function getRegistrationFormVoByIdUsingGet(
  ...
  return request<API.BaseResponseRegistrationFormVO_>('/api/registrationForm/get/vo', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listRegistrationFormByPageUsingPost(
  ...
  return request<API.BaseResponsePageRegistrationForm_>('/api/registrationForm/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listRegistrationFormVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageRegistrationFormVO_>('/api/registrationForm/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyRegistrationFormVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageRegistrationFormVO_>('/api/registrationForm/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
