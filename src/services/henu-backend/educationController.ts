...
export async function listEducationVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageEducationVO_>('/api/education/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyEducationVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageEducationVO_>('/api/education/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
