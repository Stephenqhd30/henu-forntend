...
export async function listSchoolTypeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageSchoolTypeVO_>('/api/schoolType/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMySchoolTypeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageSchoolTypeVO_>('/api/schoolType/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
