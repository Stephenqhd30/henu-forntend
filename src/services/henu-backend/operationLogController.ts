...
export async function listOperationLogByPageUsingPost(
  ...
  return request<API.BaseResponsePageOperationLog_>('/api/operationLog/list/page', {
    method: 'POST',
    headers: {
...
export async function listOperationLogVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageOperationLogVO_>('/api/operationLog/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
