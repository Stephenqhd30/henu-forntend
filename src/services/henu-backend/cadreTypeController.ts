...
export async function listCadreTypeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageCadreTypeVO_>('/api/cadreType/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyCadreTypeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageCadreTypeVO_>('/api/cadreType/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
